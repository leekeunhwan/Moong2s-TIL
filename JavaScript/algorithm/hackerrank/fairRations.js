...
// It should return an integer that represents the minimum number of loaves required.
...
// Output Format
// Print a single integer taht denotes the minimum number of loaves 
// that must be distributed so that every person has an even number of loaves.
...
// Explanation 0
// The initial distribution is (2,3,4,5,6).
...
// As there are only 2 people in the line, any time you give one person a loaf you must always give the other person a loaf.
